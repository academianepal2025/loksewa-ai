  ...
  return (
    <div className="bg-surface border border-border-subtle rounded-2xl p-6 sm:p-8">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-lg font-bold text-foreground tracking-tight mb-1">Privacy Policy</h2>
          <p className="text-xs text-subtle font-medium">Last updated: January 2025</p>
        </div>
        <div className="flex items-center gap-2">
          {isExpanded && (
            <button onClick={handlePrint} className="flex items-center gap-2 px-4 py-2.5 bg-background border border-border-subtle rounded-xl text-[10px] font-bold uppercase tracking-wider text-subtle hover:text-foreground transition-all">
              <Printer className="h-3.5 w-3.5" /> Print
            </button>
          )}
          <button 
            onClick={() => setIsExpanded(!isExpanded)}
            className="flex items-center gap-2 px-4 py-2.5 bg-orange-600 text-white rounded-xl text-[10px] font-bold uppercase tracking-wider hover:opacity-90 transition-all"
          >
