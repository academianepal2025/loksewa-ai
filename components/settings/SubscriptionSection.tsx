...
const FREE_LIMITS = { documents: 3, daily_chats: 3, total_chats: 10, daily_quizzes: 3, daily_notes: 1, active_exams: 1 };
const LIMIT_LABELS: Record<string, string> = { documents: 'Documents', daily_chats: 'Daily Chat Messages', total_chats: 'Lifetime Chat Messages', daily_quizzes: 'Daily Quizzes', daily_notes: 'Study Notes', active_exams: 'Exams' };
