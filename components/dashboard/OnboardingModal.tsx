    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-zinc-950/80 backdrop-blur-md">
      <div className="bg-white dark:bg-zinc-900 w-full max-w-md rounded-[2.5rem] shadow-2xl border border-zinc-200 dark:border-zinc-800 p-8 animate-zoom-in relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          <div className="h-16 w-16 bg-[#c9a84c]/10 rounded-2xl flex items-center justify-center text-[#c9a84c] mx-auto mb-6">
          ...
          <div className="space-y-3 mb-10">
            <button
              ...
              className="w-full p-4 rounded-2xl border-2 border-zinc-100 dark:border-zinc-800 hover:border-[#c9a84c] dark:hover:border-[#c9a84c] bg-zinc-50 dark:bg-zinc-800/50 flex items-center justify-between group transition-all"
            >
              <div className="flex items-center gap-3">
                <span className="text-xl">🇺🇸</span>
                <span className="text-sm font-bold text-zinc-900 dark:text-white">English (Standard)</span>
              </div>
              <ArrowRight className="h-4 w-4 text-zinc-300 group-hover:text-[#c9a84c] group-hover:translate-x-1 transition-all" />
            </button>
