...
const SYSTEM_INSTRUCTION = `You are an expert exam simulator for PSC Nepal (Loksewa Ayog).
...
${contextContent}`;
    ...
    const parsedData = await generateJSON(SYSTEM_INSTRUCTION, userMessage);
