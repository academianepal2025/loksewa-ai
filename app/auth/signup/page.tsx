  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white border border-gray-100 p-8 sm:p-10 rounded-3xl shadow-2xl shadow-indigo-100/20 space-y-8">
          <div className="text-center space-y-2">
            <div className="h-14 w-14 bg-[#1e3a5f] text-[#c9a84c] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl shadow-indigo-100 relative group transition-transform hover:scale-105">
            ...
            <h1 className="text-3xl font-black text-[#1e3a5f] tracking-tighter uppercase">Create Workspace</h1>
            <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Initialize your Loksewa AI mission parameters</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-[9px] uppercase tracking-[0.3em] font-black">
                <span className="bg-white px-4 text-gray-300">New Registration</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      {...register('fullName')}
                      className={`w-full bg-gray-50/50 border rounded-2xl pl-11 pr-4 py-3.5 text-sm font-bold transition-all outline-none min-h-[44px] text-[#1e3a5f] ${errors.fullName ? 'border-red-500/50 focus:border-red-500' : 'border-gray-100 focus:border-[#1e3a5f]'}`}
                      placeholder="Enter full name"
                    />
                  </div>
                  {errors.fullName && <p className="text-[10px] font-bold text-red-500 ml-1 uppercase tracking-tight">{errors.fullName.message}</p>}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      {...register('email')}
                      type="email"
                      className={`w-full bg-gray-50/50 border rounded-2xl pl-11 pr-4 py-3.5 text-sm font-bold transition-all outline-none min-h-[44px] text-[#1e3a5f] ${errors.email ? 'border-red-500/50 focus:border-red-500' : 'border-gray-100 focus:border-[#1e3a5f]'}`}
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      {...register('password')}
                      type="password"
                      className={`w-full bg-gray-50/50 border rounded-2xl pl-11 pr-4 py-3.5 text-sm font-bold transition-all outline-none min-h-[44px] text-[#1e3a5f] ${errors.password ? 'border-red-500/50 focus:border-red-500' : 'border-gray-100 focus:border-[#1e3a5f]'}`}
                      placeholder="••••••••"
                    />
                  </div>
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Mobile Uplink (+977)</label>
                  <div className="relative">
                    <Phone className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-300" />
                    <input
                      {...register('phone')}
                      className={`w-full bg-gray-50/50 border rounded-2xl pl-11 pr-4 py-3.5 text-sm font-bold transition-all outline-none min-h-[44px] text-[#1e3a5f] ${errors.phone ? 'border-red-500/50 focus:border-red-500' : 'border-gray-100 focus:border-[#1e3a5f]'}`}
              ...
              >
                {isSubmitting ? (
                  ...
                  <>Deploy Workspace <ArrowRight className="h-5 w-5" /></>
                )}
              </button>
            </form>
          </div>
          ...
          <div className="text-center pt-4 border-t border-gray-50">
            <Link href="/auth/signin" className="text-[10px] font-black text-gray-400 hover:text-[#1e3a5f] transition-colors uppercase tracking-[0.2em]">
